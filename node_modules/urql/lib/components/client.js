...
var _initialiseProps = function _initialiseProps() {
  ...
  this.invalidate = function (queryObject) {
    ...
    if (queryObject) {
      ...
      })) : cache.invalidate((0, _hash.hashString)(JSON.stringify(_this2.query)));
    }
  };
  ...
  this.formatProps = function (props) {
    ...
    if (props.query) {
      ...
      _this2.query = Array.isArray(props.query) ? props.query.map(_typenames.formatTypeNames) : (0, _typenames.formatTypeNames)(props.query); // Subscribe to change listener
    ...
    if (props.mutation) {
      ...
      Object.keys(props.mutation).forEach(function (key) {
        _this2.mutations[key] = (0, _typenames.formatTypeNames)(props.mutation[key]);
      }); // bind to mutate
